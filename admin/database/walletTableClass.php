<?php  
// CLASS TABLE USER
class walletTableClass extends connMySQLClass{
    ...
    // insert
    public function insertWallet(string $fields, string $value){
        // query
    ...
    // get
    public function selectWallet(string $fields, string $key){
        // query
    ...
    // update
    public function updateWallet(string $dataSet, string $key){
        // query
