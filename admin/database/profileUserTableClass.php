<?php  
// CLASS TABLE USER
class profileUserTableClass extends connMySQLClass{
    
    // SET ATTRIBUTE TABLE NAME
    private $table_name = "profile_user";
    ...
    public function __construct(){
        ...
        if($this->checkTable($this->table_name) == 0){
            ...
            $sql = "CREATE TABLE $this->table_name (
                ...
                number_whatsapp VARCHAR(16) NOT NULL
            )";
    ...
    // insert
    public function insertProfileUser(string $fields, string $value){
        // query
    ...
    // get
    public function selectProfileUser(string $fields, string $key){
        // query
    ...
    // update
    public function updateProfileUser(string $dataSet, string $key){
        // query
