                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <span class="text-muted text-hover-primary">Paket</span>
                                        </li>
                                        <!--end::Item-->
                            ...
                            <div id="kt_app_content_container" class="app-container container-xxl">
                                ...
                                <form class="card shadow-sm" method="post" action="">
                                    <div class="card-header">
                                        <h3 class="card-title">Data Harga Paket</h3>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!--begin::Input-->
                                        <div class="mb-3">
                                            <label for="package><?= $name ?>" class="required form-label"><?= $name ?></label>
                                            <div class="input-group">
                                                <span class="input-group-text" id="package><?= $name ?>-addon1">Rp</span>
                                                <input type="number" name="package[]" id="package><?= $name ?>" class="form-control form-control-solid" value="<?= $feePackage[$key] ?>" placeholder="cth:1000000" aria-label="package><?= $name ?>" aria-describedby="package><?= $name ?>-addon1"/>
                                            </div>
                                        </div>
                                        <!--end::Input-->
                                        <?php } ?>
