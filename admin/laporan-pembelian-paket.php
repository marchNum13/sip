...
<head>
    <base href="../"/>
    <title>SIP Admin - Laporan Pembelian Paket</title>
                                                ...
                                                <form action="" method="get" class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                                    ...
                                                    <div class="px-7 py-5">
                                                        ...
                                                        <div class="d-flex justify-content-end">
                                                            <a href="admin/laporan-pembelian-paket" class="btn btn-sm btn-light btn-active-light-primary fw-semibold me-2 px-6">Reset</a>
														...
														<td>
                                                            <div  class="d-flex align-items-center">
                                                                ...
                                                                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                                    <a href="#">
                                                                        <div class="symbol-label">
                                                                            <img src="assets/media/avatars/<?= $registBy['package'] ?>.png" alt="Emma Smith" class="w-100" />
                                                                        </div>
                                                                    </a>
                                                                </div>
                                                                <!--end::Avatar-->
                                                                <!--begin::User details-->
                                                                <div class="d-flex flex-column">
                                                                    <a href="#" class="text-gray-800 text-hover-primary mb-1"><?= ucwords($registBy['full_name']) ?></a>
                                                                    <span class="text-muted"><?= $registBy['email'] ?></span>
                                                                    <a href="https://api.whatsapp.com/send/?phone=62<?= $registBy['number_whatsapp'] ?>" target="_blank" class="text-muted">62<?= $registBy['number_whatsapp'] ?></a>
                                                                </div>
                                                                <!--begin::User details-->
                                                            </div>
                                                        </td>
                                    ...
                                    <div class="card-footer text-center">
                                        <ul class="pagination">
                                            <li class="page-item <?= $page <= 1 ? 'disabled' : '' ?>">
                                                <a class="page-link" href="admin/laporan-pembelian-paket?page=<?= $prev.$hrefAdd ?>" aria-label="Previous">
                                            ...
                                            <li class="page-item <?= $page == $i ? 'active' : '' ?>">
                                                <a class="page-link" href="admin/laporan-pembelian-paket?page=<?= $i.$hrefAdd ?>"><?= $i ?></a>
                                            </li>
                                            <?php  
                                                            }
                                                        }else{
                                            ...
                                            <li class="page-item <?= $page == $total_pages ? 'active' : '' ?>">
                                                <a class="page-link"
                                                    href="admin/laporan-pembelian-paket?page=<?= $total_pages.$hrefAdd ?>"><?= $total_pages; ?></a>
                                            </li>
                                            <?php
                                                            }elseif($page == $total_pages || $total_pages-$page < 4){
                                                    ?>
                                            <li class="page-item <?= $page == 1 ? 'active' : '' ?>">
                                                <a class="page-link" href="admin/laporan-pembelian-paket?page=1<?= $hrefAdd ?>">1</a>
                                            </li>
                                            <li class="page-item disabled">
                                                <a class="page-link">...</a>
                                            </li>
                                            ...
                                            <li class="page-item <?= $page >= $total_pages ? 'disabled' : '' ?>">
                                                <a class="page-link" href="admin/laporan-pembelian-paket?page=<?= $next.$hrefAdd ?>" aria-label="Next">
                                                    <span aria-hidden="true">»</span>
                                                </a>
                                            </li>
                                        </ul>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <form method="post" action="" class="modal-content">
                                    <div class="modal-header">
                                        <h3 class="modal-title">Konfirmasi Pembelian Paket</h3>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <hr>
                                        <img src="<?= $row['transaction_photo'] ?>" alt="" style="width: 100%;">
                                        <hr>
                                        ...
                                        <div class="form-check form-check-custom form-check-solid form-check-sm">
                                            <input class="form-check-input" type="checkbox" value="ya" name="confir"/>
                                            <label class="form-check-label" for="confir1">
                                                *Sebelum konfirmasi pembelian paket, pastikan bukti transfer di atas sudah valid.
                                            </label>
                                        </div>
                                    </div>

                                    <div class="modal-footer">
                                        <input type="hidden" name="codePembayaran" value="<?= $row['code_payment'] ?>">
                                        <button type="button" class="btn btn-sm btn-secondary" data-bs-dismiss="modal">Batal</button>
                                        <button type="submit" class="btn btn-sm btn-danger" name="tolakPembayaran">Tolak</button>
                                        <button type="submit" class="btn btn-sm btn-primary" name="terimaPembayaran">Konfirmasi</button>
                                    </div>
                                </form>
                            </div>
                        </div>
