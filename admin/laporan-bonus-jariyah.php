<?php 
    session_start();
    error_reporting(0);
    include "config/laporanBonusJariyahConfig.php";
    $pageTitle = "laporan-bonus-jariyah" 
?>
...
<head>
    <base href="../"/>
    <title>SIP Admin - Laporan Bonus Jariyah</title>
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">Bonus Jariyah</li>
                                        <!--end::Item-->
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                                <!--end::Page title-->
                                <!--begin::Actions-->
                                <div class="d-flex align-items-center gap-2 gap-lg-3"><!--begin::Menu toggle-->
                                    <?php  
                                        $hrefAddDownload = "";
                                        $dari != "" ? $hrefAddDownload .= "dari=" . $dari : '';
                                        $sampai != "" ? $hrefAddDownload .= "&sampai=" . $sampai : '';
                                    ?>
                                    <a href="admin/laporan-bonus-jariyah-download?<?= $hrefAddDownload ?>" class="btn btn-sm btn-flex btn-primary fw-bold">
                                        Download
                                    </a>
                                    <!--end::Menu toggle-->
                                    <!--begin::Menu toggle-->
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                        ...
                                        <form action="" method="get" class="px-7 py-5">
                                            ...
                                            <div class="d-flex justify-content-end">
                                                <a href="admin/laporan-bonus-jariyah" class="btn btn-sm btn-light btn-active-light-primary fw-semibold me-2 px-6">Reset</a>
                            ...
                            <div id="kt_app_content_container" class="app-container container-xxl">
                                ...
                                <div class="card shadow-sm">
                                    <div class="card-header">
                                        <h3 class="card-title">Data Bonus </h3>
                                    </div>
                                    <div class="card-body">
                                        <!-- begin::Table-->
                                            ...
                                            <table class="table table-hover align-middle table-row-dashed fs-8 gy-5">
                                                <thead>
                                                    <tr class="fw-bold fs-6 text-gray-800">
                                                        <th class="min-w-150px">Penerima Bonus</th>
                                                    ...
                                                    <?php  
                                                        ...
                                                        if($dataTable['row'] == 0){
                                                            ...
                                                            foreach($dataTable['data'] as $row){
                                                                $penerima = dataUser($row['id_user_upline']);
                                                                $pemberi = dataUser($row['id_user_dowline']);
                                                                $bank = dataBank($row['id_user_upline']);
                                                    ?>
                                                    <tr>
														<td>
                                                            <div  class="d-flex align-items-center">
														...
														<td>
                                                            <div  class="d-flex align-items-center">
                                                                ...
                                                                <!--begin::User details-->
                                                                <div class="d-flex flex-column">
                                                                    <a href="#" class="text-gray-800 text-hover-primary mb-1"><?= ucwords($pemberi['username']) ?><span class="badge badge-light-secondary"> GEN <?= $row['lvl'] ?></span></a>
														...
														<td>
															<div class="fw-bold">
                                                                <?= $row['category'] == "Buy Package" ? "Pembelian Paket" : $row['category'] ?>
                                                            </div>
														</td>
                                                    </tr>
                                                    <?php }} ?>
                                    ...
                                    <div class="card-footer text-center">
                                        <ul class="pagination">
                                            <li class="page-item <?= $page <= 1 ? 'disabled' : '' ?>">
                                                <a class="page-link" href="admin/laporan-bonus-jariyah?page=<?= $prev.$hrefAdd ?>" aria-label="Previous">
                                            ...
                                            <li class="page-item <?= $page == $i ? 'active' : '' ?>">
                                                <a class="page-link" href="admin/laporan-bonus-jariyah?page=<?= $i.$hrefAdd ?>"><?= $i ?></a>
                                            </li>
                                            <?php  
                                                            }
                                                        }else{
                                            ...
                                            <li class="page-item <?= $page == $total_pages ? 'active' : '' ?>">
                                                <a class="page-link"
                                                    href="admin/laporan-bonus-jariyah?page=<?= $total_pages.$hrefAdd ?>"><?= $total_pages; ?></a>
                                            </li>
                                            <?php
                                                            }elseif($page == $total_pages || $total_pages-$page < 4){
                                                    ?>
                                            <li class="page-item <?= $page == 1 ? 'active' : '' ?>">
                                                <a class="page-link" href="admin/laporan-bonus-jariyah?page=1<?= $hrefAdd ?>">1</a>
                                            </li>
                                            <li class="page-item disabled">
                                                <a class="page-link">...</a>
                                            </li>
                                            ...
                                            <li class="page-item <?= $page >= $total_pages ? 'disabled' : '' ?>">
                                                <a class="page-link" href="admin/laporan-bonus-jariyah?page=<?= $next.$hrefAdd ?>" aria-label="Next">
                                                    <span aria-hidden="true">»</span>
                                                </a>
                                            </li>
                                        </ul>
