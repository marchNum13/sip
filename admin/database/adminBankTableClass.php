<?php  
// CLASS TABLE USER
class adminBankTableClass extends connMySQLClass{
    
    // SET ATTRIBUTE TABLE NAME
    private $table_name = "admin_bank";
    ...
    // insert
    public function insertAdminBank(string $fields, string $value){
        // query
    ...
    // get
    public function selectAdminBank(string $fields, string $key){
        // query
    ...
    // update
    public function updateAdminBank(string $dataSet, string $key){
        // query
