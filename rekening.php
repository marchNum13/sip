<?php 
    session_start();
    error_reporting(0);
    include "config/rekeningConfig.php"; 
    $pageTitle = "rekening";
?>
...
<head>
    <title>SIP Member - Rekening</title>
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <span class="text-muted text-hover-primary">Rekening</span>
                                        </li>
                                        <!--end::Item-->
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-xxl">
                                ...
                                <form class="card shadow-sm" method="post" action="">
                                    ...
                                    <div class="card-body">
                                        <!--begin::Input nama pemeilik-->
                                        <div class="mb-3">
                                            <label for="namaPemilik" class="required form-label">Nama Pemilik</label>
                                            <input type="text" name="namaPemilik" id="namaPemilik" class="form-control form-control-solid" value="<?= $namaPemilik ?>" placeholder="Masukkan nama pemilik rekening..."/>
                                        </div>
                                        <!--end::Input nama pemeilik-->

                                        <!--begin::Input nama bank-->
                                        <div class="mb-3">
                                            <label for="bank" class="required form-label">Bank</label>
                                            <input type="text" name="bank" id="bank" class="form-control form-control-solid" value="<?= $bank ?>" placeholder="Masukkan nama bank..."/>
                                        </div>
                                        <!--end::Input nama bank-->

                                        <!--begin::Input no rek-->
                                        <div class="mb-3">
                                            <label for="noRek" class="required form-label">No. Rekening</label>
                                            <input type="number" name="noRek" id="noRek" class="form-control form-control-solid" value="<?= $noRek ?>" placeholder="Masukkan nomor rekening..."/>
                                        </div>
                                        <!--end::Input no rek-->
                                    </div>
