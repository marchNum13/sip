<?php  
// CLASS TABLE USER
class rewardTableClass extends connMySQLClass{
    ...
    // insert
    public function insertReward(string $fields, string $value){
        // query
    ...
    // get
    public function selectReward(string $fields, string $key){
        // query
    ...
    // update
    public function updateReward(string $dataSet, string $key){
        // query
