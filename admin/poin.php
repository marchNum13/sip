...
<head>
    <base href="../"/>
    <title>SIP Admin - Bonus Poin</title>
                            ...
                            <div id="kt_app_content_container" class="app-container container-xxl">
                                ...
                                <form class="card shadow-sm" method="post" action="">
                                    <div class="card-header">
                                        <h3 class="card-title">Data Bonus Poin</h3>
                                    ...
                                    <div class="card-body">
                                        <?php foreach($poinJum as $key => $jumpoin){ ?>
                                        <!-- begin:: -->
                                         <div class="mb-2">
                                             <label for="lvl1" class="form-label mb-0"><?= number_format($jumpoin) ?> Poin</label>
                                             <hr>
                                             <div class="row">
                                                 <div class="col-6">
                                                     <!--begin::Input-->
                                                     <div class="mb-3">
                                                         <div class="input-group">
                                                                <?php if($jumpoin < 50000){ ?>
                                                                    <span class="input-group-text" id="<?= $jumpoin ?>-addon1">Rp</span>
                                                                    <input type="number" name="reward[]" id="<?= $jumpoin ?>" class="form-control form-control-solid" value="<?= $rewardPoin[$key] ?>" placeholder="cth:1000000" aria-label="<?= $jumpoin ?>" aria-describedby="<?= $jumpoin ?>-addon1"/>
                                                                <?php }else{ ?>
                                                                    <input type="number" name="reward[]" id="<?= $jumpoin ?>" class="form-control form-control-solid" value="<?= $rewardPoin[$key] ?>" placeholder="cth:1000000" aria-label="<?= $jumpoin ?>" aria-describedby="<?= $jumpoin ?>-addon1"/>
                                                                    <span class="input-group-text" id="<?= $jumpoin ?>-addon1">%</span>
                                                                <?php } ?>
                                                         </div>
                                                     </div>
                                                     <!--end::Input-->
                                                 ...
                                                 <div class="col-6">
                                                     <!--begin::Input-->
                                                     <div class="mb-3">
                                                         <input type="text" name="ket[]" value="<?= $deskPoin[$key] ?>" class="form-control form-control-solid" placeholder="Keterangan"/>
                                                     </div>
                                                     <!--end::Input-->
                                                 </div>
                                             </div>
