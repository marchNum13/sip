<?php  
// CLASS TABLE USER
class voucherTableClass extends connMySQLClass{
    ...
    // insert
    public function insertVoucher(string $fields, string $value){
        // query
    ...
    // get
    public function selectVoucher(string $fields, string $key){
        // query
    ...
    // update
    public function updateVoucher(string $dataSet, string $key){
        // query
