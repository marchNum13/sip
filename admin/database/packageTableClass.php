<?php  
// CLASS TABLE USER
class packageTableClass extends connMySQLClass{
    ...
    public function __construct(){
        ...
        if($this->checkTable($this->table_name) == 0){
            ...
            $sql = "CREATE TABLE $this->table_name (
                ...
                name ENUM('Hamdalah', 'Basmalah') NOT NULL UNIQUE,
                fee DOUBLE NOT NULL
            )";
    ...
    // insert
    public function insertPackage(string $fields, string $value){
        // query
    ...
    // get
    public function selectPackage(string $fields, string $key){
        // query
    ...
    // update
    public function updatePackage(string $dataSet, string $key){
        // query
