...
<head>
    <title>SIP Member - Laporan Bonus Jariyah</title>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="">
                                                ...
                                                <h3 class="mb-0 text-white">Rp<?= number_format(($countDataTable['jumlah']-($countDataTable['jumlah']*0.025))) ?>
                                                </h3>
                                            </div>
                                            ...
                                            <table class="table table-hover align-middle table-row-dashed fs-8 gy-5">
                                                <thead>
                                                    <tr class="fw-bold fs-6 text-gray-800">
                                                        ...
                                                        <th class="min-w-130px">Jumlah</th>
                                                    ...
                                                    <tr>
														<td>
                                                            <div  class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex flex-column">
                                                                    <a href="#" class="text-gray-800 text-hover-primary mb-1"><?= $pemberi['username'] ?><span class="badge badge-light-secondary"> GEN <?= $row['lvl'] ?></span></a>
														...
														<td>
                                                            <div class="d-flex flex-column">
                                                                ...
                                                                <span class="text-muted">Admin: Rp<?= number_format($row['reward']*0.025) ?></span>
                                                            </div>
                                                        </td>
														<td>
															<div class="fw-bold">
