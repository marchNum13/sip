                        ...
                        <form class="form w-100" method="post" action="">
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <input type="text" placeholder="Username" name="username" autocomplete="off"
                                    class="form-control bg-transparent" value="<?= $username ?>"/>
                                <!--end::Email-->
                            </div>
                            <!--end::Input group=-->
                            ...
                            <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
                                <div></div>
                                <!--begin::Link-->
                                <!-- <a href="" class="text-cloro">Forgot Password ?</a> -->
                                <!--end::Link-->
                            </div>
                            <!--end::Wrapper-->
                            <!--begin::Submit button-->
                            <div class="d-grid mb-10">
                                <button type="submit" class="btn btn-primer" name="loginAdmin" onclick="toggleLoading(this)">
