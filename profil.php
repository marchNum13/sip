<?php
    session_start();
    error_reporting(0);
    include "config/profilConfig.php"; 
    $pageTitle = "profil" 
?>
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <span class="text-muted text-hover-primary">Profil</span>
                                        </li>
                                        <!--end::Item-->
                                ...
                                <form class="card shadow-sm" method="post" action="">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="username" id="username" class="form-control form-control-solid" value="<?= $username ?>" placeholder="Masukkan username anda..."/>
                                        </div>
                                        <!--end::Input username-->
                                        <!--begin::Input alamat email-->
                                        <div class="mb-3">
                                            <label for="email" class="required form-label">Alamat Email</label>
                                            <input type="text" name="email" id="email" class="form-control form-control-solid" value="<?= $email ?>" placeholder="Masukkan email anda..."/>
                                        </div>
                                        <!--end::Input alamat email-->
                                        <!--begin::Input nama lengkap-->
                                        <div class="mb-3">
                                            <label for="fullname" class="required form-label">Nama Lengkap</label>
                                            <input type="text" name="fullname" id="fullname" class="form-control form-control-solid" value="<?= $fullname ?>" placeholder="Masukkan nama lengkap anda..."/>
                                        </div>
                                        <!--end::Input nama lengkap-->
                                        <!--begin::Input nama lengkap-->
                                        <div class="mb-3">
                                            <label for="wa" class="required form-label">Whatsapp</label>
                                            <div class="input-group">
                                                <span class="input-group-text">+62</span>
                                                <input type="text" name="wa" id="wa" class="form-control form-control-solid" value="<?= $wa ?>" placeholder="Masukkan no whatsapp anda..."/>
                                            </div>
                                        </div>
                                        <!--end::Input nama lengkap-->
                                    </div>
