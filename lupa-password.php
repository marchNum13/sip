<?php  
    session_start();
    error_reporting(0);
    include "config/lupaPasswword.php"
?>
<!DOCTYPE html>
<html lang="en">
<!--begin::Head-->
...
<head>
    <title>SIP Member - Lupa Password</title>
                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                        ...
                        <form class="form w-100" method="post" action="">
                            ...
                            <div class="fv-row mb-8">
                                <!--begin::Email-->
                                <input type="text" placeholder="Masukkan email yang terdaftar" name="emailInput" autocomplete="off"
                                    class="form-control bg-transparent" id="emailInput" value="<?= $emailInput ?>"/>
                                <!--end::Email-->
                            </div>
                            <!--end::Input group=-->
                            <!--begin::Wrapper-->
                            ...
                            <div class="d-grid mb-10">
                                <button type="sumbit" class="btn btn-primer" name="kirimOTP" onclick="toggleLoading(this)">
