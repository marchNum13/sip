...
<head>
    <base href="../"/>
    <title>SIP Admin - Laporan Withdraw</title>
                                                ...
                                                <tbody class="text-gray-600 fw-semibold">
                                                    <tr>
														<td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                                    <a href="#">
                                                                        <div class="symbol-label">
                                                                            <img src="assets/media/avatars/Basmalah.png" alt="Emma Smith" class="w-100" />
                                                                        </div>
                                                                    </a>
                                                                </div>
                                                                <!--end::Avatar-->
                                                                ...
                                                                <div class="d-flex flex-column">
                                                                    ...
                                                                    <span class="text-muted">smith@kpmg.com</span>
                                                                    <a href="" class="text-muted">0877XXXX</a>
                                                                </div>
                                                                <!--begin::User details-->
                                                            </div>
                                                        </td>
														<td>
                                                            ...
                                                            <a href="#" data-bs-toggle="modal" data-bs-target="#confir_1" class="badge badge-warning fw-bold">Menunggu</a>
                                                        </td>
