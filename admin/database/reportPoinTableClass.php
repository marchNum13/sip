<?php  
// CLASS TABLE USER
class reportPoinTableClass extends connMySQLClass{
    
    // SET ATTRIBUTE TABLE NAME
    private $table_name = "report_poin";
    ...
    // insert
    public function insertReportPoin(string $fields, string $value){
        // query
    ...
    // get
    public function selectReportPoin(string $fields, string $key){
        // query
    ...
    // update
    public function updateReportPoin(string $dataSet, string $key){
        // query
