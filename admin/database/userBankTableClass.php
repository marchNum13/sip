<?php  
// CLASS TABLE USER
class userBankTableClass extends connMySQLClass{
    
    // SET ATTRIBUTE TABLE NAME
    private $table_name = "user_bank";
    ...
    // insert
    public function insertUserBank(string $fields, string $value){
        // query
    ...
    // get
    public function selectUserBank(string $fields, string $key){
        // query
    ...
    // update
    public function updateUserBank(string $dataSet, string $key){
        // query
