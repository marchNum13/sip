<?php 
    session_start();
    error_reporting(0);
    include "config/jariyahConfig.php";
    $pageTitle = "jariyah";
?>
...
<head>
    <base href="../"/>
    <title>SIP Admin - Bonus Jariyah</title>
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">Jariyah</li>
                                        <!--end::Item-->
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                            ...
                            <div id="kt_app_content_container" class="app-container container-xxl">
                                ...
                                <form class="card shadow-sm" method="post" action="">
                                    <div class="card-header">
                                        <h3 class="card-title">Data Bonus Jariyah</h3>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <?php foreach($lvlBonus as $key => $lvl){ ?>
                                            <div class="<?= $lvl == 1 ? 'col-12' : 'col-6' ?> col-sm-6">
                                                <!--begin::Input-->
                                                <div class="mb-3">
                                                    <label for="lvl<?= $lvl ?>" class="required form-label">Generasi <?= $lvl ?></label>
                                                    <div class="input-group">
                                                        <span class="input-group-text" id="lvl<?= $lvl ?>-addon1">Rp</span>
                                                        <input type="number" name="reward[]" id="lvl<?= $lvl ?>" class="form-control form-control-solid" value="<?= $rewardLvl[$key] ?>" placeholder="cth:1000000" aria-label="lvl<?= $lvl ?>" aria-describedby="lvl<?= $lvl ?>-addon1"/>
                                                    </div>
                                                </div>
                                                <!--end::Input-->
                                            </div>
